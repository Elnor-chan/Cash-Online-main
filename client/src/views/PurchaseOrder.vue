    ...
    <div class="app-container" style="padding: 20px;">
        <el-card>
            ...
            <el-form :inline="true" label-width="100px">
                ...
                <el-form-item label="预计收货">
                    <el-date-picker v-model="form.expected_delivery_date" type="date" placeholder="选择日期"
                        style="width: 180px" />
                </el-form-item>
                <el-form-item label="供应商">
                    <el-select v-model="form.partner_ref" placeholder="选择供应商" filterable style="width: 200px">
            ...
            <el-table :data="form.items" border style="width: 100%" size="small">
                ...
                <el-table-column label="订购单价" width="120">
                    <template #default="scope">
...
const submitOrder = async () => {
    if (!form.partner_ref || totalAmount.value <= 0) {
        ElMessage.warning('请选择供应商并填写订单明细');
        return;
    }
    ...
    const payload = {
        ...
        expected_delivery_date: dayjs(form.expected_delivery_date).format('YYYY-MM-DD'),
    ...
    try {
        ...
        ElMessage.success(`订单创建成功! PO号: ${res.data.poNumber}`);
        // 重置表单
        const defaultCurr = currencies.value.find(c => c.symbol === 'CNY');
        Object.assign(form, {
            order_date: dayjs().toDate(),
